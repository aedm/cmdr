...
mod tests {
    ...
    fn test_failed_multicast_join_records_interface() {
        ...
        let if_index = 65_535;
        let intf = if_addrs::Interface {
            name: "mdns-sd-unjoinable".to_string(),
