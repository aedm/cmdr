...
- [x] Install Apple's intermediate certificate by downloading and double-clicking:
...
- [x] Find **Developer ID Application: Rymdskottkarra AB (83H6YAQMNP)** and expand it to verify it has a private key
...
- [x] Base64-encode it:
  ...
  ```
  This is now in your clipboard. Paste it as `APPLE_CERTIFICATE` in GitHub Secrets.
