...
- **The cancelled-rollback toast (`fileOperations.cancelRollback.*`, 19 keys).** Nothing forks. Its whole vocabulary is
  ...
  dialects. Checked against the pile when the strings landed, 2026-08-31. The two `stagedLeftover.*` keys added
