<script lang="ts">
    ...
    const USAGE: Record<IconName, string> = {
        ...
        'chart-no-axes-column': 'The usage-stats row of the onboarding open-beta checklist.',
        ...
        heart: 'The "Like Cmdr on AlternativeTo" row of the onboarding open-beta checklist.',
        hourglass:
        ...
        mail: 'The email row of the onboarding open-beta checklist.',
        ...
        pin: 'The "Pin to switcher" row action on a saved server, in the volume switcher row\'s submenu and the servers hub\'s row menu.',
        'pin-off': 'The "Unpin" row action on a pinned server, in the volume switcher row\'s submenu and the servers hub\'s row menu.',
        ...
        star: 'The "Star the repo on GitHub" row of the onboarding open-beta checklist.',
        'star-off': 'The "Remove from favorites" row action in a favorite\'s submenu in the favorites menu.',
