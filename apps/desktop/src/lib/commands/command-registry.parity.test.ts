...
const EXPECTED_NAMES: Record<string, string> = {
  ...
  'cloud.openInGoogleDrive': 'Open in Google Drive',
  'cloud.copyGoogleDriveLink': 'Copy Google Drive link',
  'cloud.askGemini': 'Ask Gemini',
  ...
  'volume.close': 'Close volume switcher',
