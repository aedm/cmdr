        ...
        $consumer! {
            ...
            cfg(all()) {
                typed: [
                    ...
                    // update_view_mode_menu, set_ui_language}`,
                    ...
                    crate::commands::agent::ask_cmdr_legacy_opt_in,
                    crate::commands::agent::ask_cmdr_enabled_changed,
                ...
                dispatch_only: [
                    ...
                    crate::commands::menu_state::update_select_same_kind_menu,
                    crate::commands::menu_state::set_reopen_closed_tab_enabled,
                    crate::commands::menu_state::set_file_operations_blocked,
                    crate::commands::menu_state::set_commands_refused_over_dialog,
                    crate::commands::menu_state::set_open_terminal_here_enabled,
                    crate::commands::menu_state::activate_window_menu,
                    crate::commands::menu_state::toggle_hidden_files,
                    crate::commands::menu_state::sync_menu_show_hidden,
                    crate::commands::menu_state::update_view_mode_menu,
                    crate::commands::menu_state::set_ui_language,
            ...
            cfg(any(target_os = "macos", target_os = "linux")) {
                typed: [
                    ...
                    crate::commands::network::get_smb_direct_connection_enabled,
                    crate::commands::network::set_smb_direct_connection_enabled,
            ...
            cfg(not(any(target_os = "macos", target_os = "linux"))) {
                typed: [
                    ...
                    crate::stubs::network::get_smb_direct_connection_enabled,
                    crate::stubs::network::set_smb_direct_connection_enabled,
...
pub fn builder() -> Builder<tauri::Wry> {
    ...
    Builder::<tauri::Wry>::new()
        ...
        .events(collect_events![
            ...
            IndexNeedsFreshScanEvent,        // event_name = "index-needs-fresh-scan"
