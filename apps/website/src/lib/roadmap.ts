      ...
      },
      {
        ...
        milestones: [
          ...
          },
          {
            ...
            description: 'Start a new Terminal, Ghostty, Warp, etc. tab in the current folder.',
            done: true,
          },
          {
            date: '(Sep 6)',
            title: 'Browse Office docs',
            description: 'Open a .docx, .xlsx, or .pptx like a folder (read-only).',
            done: true,
          },
          {
            date: '(Sep 7)',
            title: 'SFTP',
            description: 'Mount an SSH server like a local volume. Supports host-key checks and key files.',
            icon: 'server',
            done: true,
          },
          {
            date: '(Sep 8)',
            title: 'WebDAV',
            description: 'Open Nextcloud, ownCloud, Synology, Fastmail, etc., like a local volume.',
            done: true,
          },
          {
            date: '(Sep 9)',
          ...
          {
            date: '(Sep 11)',
            title: 'Android over ADB',
            description: "Browse your phone's whole filesystem over USB. Even cooler than MTP!",
            done: true,
          },
          {
            date: '(Sep 12)',
            title: 'Cloud provider menus',
