...
export const notInPlaceYet: string[] = [
  ...
  "<strong>One maintainer account can publish a release</strong> to every install. There's no second-person review.",
  ...
  '<strong>Dependency vulnerability scans run every six days</strong>, not on every change.',
